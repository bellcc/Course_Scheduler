public class Course {
	...
	public String toString() {
		...
		String str = course_num + "*" + course + "*" + hours + "*" + enrollment + "*" + max_enrollment + "*" + room + "*" + meeting_category + "*" + subject + "*" + section + "*" + title + "*" + days + "*" + building + "*" + instructor + "*" + meeting_type + "*" + start_time + "*" + end_time + "*" + exam_day + "*" + exam_time;
